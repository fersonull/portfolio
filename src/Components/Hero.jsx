...
const Hero = () => {
  return (
    <div
      className="font-ovo min-h-screen flex flex-col items-center justify-center px-4 relative"
      id="home"
    >
      ...
      <AnimatedDiv className="flex flex-col items-center justify-center gap-3 md:mb-4 mb-2 z-10">
        <ImageRound
      ...
      <AnimatedText
        delay={0.6}
        className="md:text-5xl text-2xl md:max-w-xl text-center md:mb-4 mb-2  z-10"
      >
      ...
      <AnimatedText
        delay={0.9}
        className="text-sm max-w-md md:max-w-lg text-center mb-5 z-10"
      >
